...
class GameWindow:
    def __init__(self):
        ...
        # background
        self.background_image = pygame.image.load("outruntest/textures/bg.png").convert_alpha()
        ...
        self.sprites.append(pygame.image.load("outruntest/textures/oak.png").convert_alpha())
